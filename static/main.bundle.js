...
module.exports = "<nav *ngIf=\"authService.isLoggedIn()\" class=\"navbar navbar-expand-lg navbar-dark bg-dark\">\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarNav\" aria-controls=\"navbarNav\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n\n  <div class=\"collapse navbar-collapse\" id=\"navbarNav\">\n    <ul class=\"navbar-nav\">\n\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" routerLink=\"\" routerLinkActive=\"active\" [routerLinkActiveOptions]=\"{ exact: true }\">Home</a>\n      </li>\n\n    </ul>\n  </div>\n\n  <a class=\"btn btn-primary btn-sm\" [routerLink]=\"['/login']\">Logout</a>\n</nav>\n"
...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.login = function (email, password) {
        ...
        return this.http.post(this.DOMAIN + 'api/accounts/login/', JSON.stringify({ email: email, password: password }), { headers: myHeader })
...
var UserService = (function () {
    ...
    UserService.prototype.getUsers = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'Authorization': 'Token ' + this.authenticationService.token });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: headers });
        return this.http.get('http://127.0.0.1:8000/api/users/', options)
            .map(function (response) { return response.json(); });
    };
    UserService.prototype.createUser = function (email, password, first_name, last_name) {
    ...
    UserService.prototype.manageUser = function (id, blocked) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'Authorization': 'Token ' + this.authenticationService.token, 'Content-Type': 'application/json' });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: headers });
        var json = JSON.stringify({ is_active: blocked });
...
var routes = [
    ...
    { path: '', component: __WEBPACK_IMPORTED_MODULE_2__home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_5__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: '**', redirectTo: '' }
];
...
// module
exports.push([module.i, ".whiteboard-container {\r\n    padding: 0px;\r\n    margin: 0px;\r\n    max-width: 100%;\r\n}\r\n\r\n.whiteboard-side, .whiteboard-body {\r\n    padding: 0px;\r\n    min-height: 100%;\r\n    height: 100%;\r\n}\r\n\r\n.whiteboard-side {\r\n    \r\n}\r\n\r\n.whiteboard-body {\r\n    border-left: 1px solid #212529;\r\n}", ""]);
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authenticationService.login(this.model.email, this.model.password)
            .subscribe(function (data) { _this.router.navigate(['/']); }, function (err) {
            _this.error = Object.values(JSON.parse(err._body))[0];
            _this.loading = false;
        });
    };
...
module.exports = "<div class=\"container\" style=\"padding-top: 50px\">\n    <div class=\"row justify-content-md-center\">\n        <div class=\"col-md-4\">\n            <h2>Register</h2>\n\n            <form (ngSubmit)=\"register()\" novalidate>\n                <div class=\"form-group\">\n                    <label for=\"email\">Email</label>\n                    <input type=\"email\" class=\"form-control\" [(ngModel)]=\"model.email\" name=\"email\" required />\n                </div>\n                <div class=\"form-group\">\n                    <label for=\"first_name\">First name</label>\n                    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"model.first_name\" name=\"first_name\" required />\n                </div>\n                <div class=\"form-group\">\n                    <label for=\"last_name\">Last name</label>\n                    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"model.last_name\" name=\"last_name\" required />\n                </div>\n                <div class=\"form-group\">\n                    <label for=\"password\">Password</label>\n                    <input type=\"password\" class=\"form-control\" [(ngModel)]=\"model.password\" name=\"password\" required />\n                </div>\n                <div *ngIf=\"error\" class=\"alert alert-danger\">{{ error }}</div>\n\n                <div class=\"form-group\">\n                    <button [disabled]=\"loading\" class=\"btn btn-primary\">Register</button>\n                </div>\n\n                <span>Already have an accout? </span><a routerLink=\"/login\">Login</a>\n            </form>\n        </div>\n    </div>\n</div>\n"
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        this.userService.createUser(this.model.email, this.model.password, this.model.first_name, this.model.last_name)
            .subscribe(function (data) { _this.router.navigate(['/login']); }, function (err) {
            _this.error = Object.keys(JSON.parse(err._body))[0] + ': ' + Object.values(JSON.parse(err._body))[0];
            _this.loading = false;
        });
    };
